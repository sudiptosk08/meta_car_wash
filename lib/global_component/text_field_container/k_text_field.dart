...
class KTextField extends StatefulWidget {
  ...
  KTextField({super.key, 
    ...
    this.textColor = KColor.navbarGrey,
...
class _KTextFieldState extends State<KTextField> {
            ...
            children: [
              Text(widget.labelText ?? '',
                  ...
                  style: TextStyles.bodyText2.copyWith(
                      color: widget.laveltextColor ?? KColor.navbarGrey.withOpacity(0.7))),
              if (widget.requiredField!)
                Text('*',
                    textAlign: TextAlign.center,
                    style: TextStyles.bodyText2.copyWith(color: KColor.yellow)),
            ],
          ),
        Container(
          ...
          padding: EdgeInsets.symmetric(
              horizontal: KSize.getWidth(context, 16), vertical: 0),
          margin:
          ...
          child: TextFormField(
            ...
            style: TextStyles.bodyText1
                .copyWith(color: widget.textColor ?? KColor.navbarGrey),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyles.bodyText1.copyWith(
                  color:
                      widget.hintColor ?? KColor.navbarGrey.withOpacity(0.5)),
  ...
  GestureDetector clearField() {
    return GestureDetector(
      ...
      child: Icon(
        Icons.cancel,
        color: _isClearableText ? KColor.black : KColor.transparent,
        size: 16.0,
      ),
    );
  }
